...
class AutoSchedule(ffi.AutoSchedule):
    ...
    def __init__(self,
                 ...
                 *,
                 ...
                 rule_set=None,
                 verbose=0,
                 lower_func_multicall_api=None,
                 multicall_result_api=None):
        '''
        Automatic scheduler
        ...
        self.lower_func_multicall_api = lower_func_multicall_api
        self.multicall_result_api = multicall_result_api
        ...
        super(AutoSchedule,
              self).__init__(schedule, target, device, predict_func,
                             ...
                             rule_set, verbose,
                             lower_func_multicall_api,
                             multicall_result_api
                             )
