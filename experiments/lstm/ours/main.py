...
def compile_all(in_feats, hidden_feats, length, device):
    ...
    def inference(x, y, w, u, b):
        ft.declare_var(x, (length, in_feats), "float32", "input", mtype)
        ft.declare_var(y, (hidden_feats,), "float32", "output", mtype)
        ft.declare_var(w, (4, in_feats, hidden_feats), "float32", "input",
                       mtype)
        ft.declare_var(u, (4, hidden_feats, hidden_feats), "float32", "input",
                       mtype)
        ft.declare_var(b, (4, hidden_feats), "float32", "input", mtype)
