...
def test_thread_bind():
    ...
    @ir.transform
    def test(w, x, y, z):
        ir.declare_var(w, (m, m, a, b), "int32", "input", "gpu/global")
        ir.declare_var(x, (m, m, b, a), "int32", "input", "gpu/global")
        ir.declare_var(y, (1, 1, a, a), "int32", "cache", "gpu/global")
        ir.declare_var(z, (m, m, a, a), "int32", "output", "gpu/global")
        "nid: L1"
        for i in range(m):
            "nid: L2"
            for j in range(m):
