...
def test_basic():
    ...
    ast = ft.pop_ast()
    print(ast)
    _, ast, _, _, _ = ft.grad(ast, set(["x1", "x2", "x3"]), set(["y"]), set())
    print(ast)
    ast = ft.lower(ast)
    print(ast)
...
def test_partial_gradient():
    ...
    ast = ft.pop_ast()
    print(ast)
    _, ast, _, _, _ = ft.grad(ast, set(["x1"]), set(["y"]), set())
    print(ast)
    ast = ft.lower(ast)
    print(ast)
...
def test_branching_exprs():
    ...
    ast = ft.pop_ast()
    print(ast)
    _, ast, _, _, _ = ft.grad(ast, set(["x1", "x2"]), set(["y1", "y2", "y3"]),
                              set())
    print(ast)
    ast = ft.lower(ast)
    print(ast)
...
def test_math_funcs():
    ...
    ast = ft.pop_ast()
    print(ast)
    _, ast, _, _, _ = ft.grad(ast, set(["x"]), set(["y1", "y2", "y3"]), set())
    print(ast)
    ast = ft.lower(ast)
    print(ast)
...
def test_multiple_statements():
    ...
    ast = ft.pop_ast()
    print(ast)
    _, ast, _, _, _ = ft.grad(ast, set(["x1", "x2", "x3"]), set(["y1", "y2"]),
                              set())
    print(ast)
    ast = ft.lower(ast)
    print(ast)
...
def test_dependent_iterations():
    ...
    ast = ft.pop_ast()
    print(ast)
    _, ast, _, _, _ = ft.grad(ast, set(["x"]), set(["y"]), set())
    print(ast)
    ast = ft.lower(ast)
    print(ast)
...
def test_nested_loops():
    ...
    ast = ft.pop_ast()
    print(ast)
    _, ast, _, _, _ = ft.grad(ast, set(["x", "w0", "w1"]), set(["y"]), set())
    print(ast)
    ast = ft.lower(ast)
    print(ast)
...
def test_tape_1():
    ...
    ast = ft.pop_ast()
    print(ast)
    forward, backward, _, _, _ = ft.grad(ast, set(["x1", "x2", "x3"]),
                                         set(["y"]), set(["V_t"]))
    print("Forward:")
    print(forward)
    print("Backward:")
...
def test_tape_3():
    ...
    ast = ft.pop_ast()
    print(ast)
    forward, backward, _, _, _ = ft.grad(ast, set(["x2"]), set(["y"]),
                                         set(["V_t"]))
    print("Forward:")
    print(forward)
    print("Backward:")
...
def test_tape_4():
    ...
    ast = ft.pop_ast()
    print(ast)
    forward, backward, _, _, _ = ft.grad(ast, set(["x"]), set(["y"]),
                                         set(["V_t"]))
    print("Forward:")
    print(forward)
    print("Backward:")
...
def test_tape_5():
    ...
    ast = ft.pop_ast()
    print(ast)
    forward, backward, _, _, _ = ft.grad(ast, set(["x", "u"]), set(["y"]),
                                         set([":h", ":f"]))
    print("Forward:")
    print(forward)
    print("Backward:")
...
def test_hoist_tape_out_of_loop():
    ...
    print(func)
    forward, backward, _, _, _ = ft.grad(func, set(["x1", "x2", "x3"]),
                                         set(["y"]), set(["V_t"]))
    print("Forward:")
    print(forward)
    print("Backward:")
...
def test_tape_mode_no_reuse_only():
    ...
    ast = ft.pop_ast()
    print(ast)
    forward, backward, _, _, _ = ft.grad(ast, set(["x1", "x2",
                                                   "x3"]), set(["y"]),
...
def test_no_deps():
    ...
    def test(ptr, edge1, edge2):
        ...
        ft.declare_var(edge1, (50,), "float32", "input", "cpu")
        ft.declare_var(edge2, (50,), "float32", "output", "cpu")
        'nid: Li'
        'no_deps: edge2'
        for i in range(10):
    ...
    print(test)
    _, backward, _, _, _ = ft.grad(test, set(["edge1"]), set(["edge2"]), set())
    print(backward)
