...
def test_trans_A():
    ...
    def f(a, b, y):
        ...
        ir.declare_var(y, (4, 6), "float32", "output", "cpu")
        "nid: gemm"
        ir.libop.gemm_(a, b, None, y, trans_A=True)
...
def test_trans_B():
    ...
    def f(a, b, y):
        ...
        ir.declare_var(y, (4, 6), "float32", "output", "cpu")
        "nid: gemm"
        ir.libop.gemm_(a, b, None, y, trans_B=True)
...
def test_trans_AB():
    ...
    def f(a, b, y):
        ...
        ir.declare_var(y, (4, 6), "float32", "output", "cpu")
        "nid: gemm"
        ir.libop.gemm_(a, b, None, y, trans_A=True, trans_B=True)
...
def test_bias_with_coeff():
    ...
    def f(a, b, c, y):
        ...
        ir.declare_var(y, (4, 6), "float32", "output", "cpu")
        "nid: gemm"
        ir.libop.gemm_(a, b, c, y, alpha=2.5, beta=3.8)
