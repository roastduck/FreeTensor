...
def test_same_static_shape():
    ...
    def f(x, y, out):
        ...
        "nid: add"
        ir.libop.add(T("float32", 2), T("float32", 2), T("float32", 2),
                     "cpu")([4, 4], [4, 4], out_shape, x, y, out)
...
def test_static_broadcast_shorter():
    ...
    def f(x, y, out):
        ...
        out_shape = ir.create_var((2,), "int32", "cache", "cpu")
        "nid: add"
        ir.libop.add(T("float32", 1), T("float32", 2), T("float32", 2),
                     "cpu")([4], [4, 4], out_shape, x, y, out)
...
def test_different_dtype():
    ...
    def f(x, y, out):
        ...
        out_shape = ir.create_var((2,), "int32", "cache", "cpu")
        "nid: add"
        ir.libop.add(T("int32", 2), T("float32", 2), T("float32", 2),
                     "cpu")([4, 4], [4, 4], out_shape, x, y, out)
